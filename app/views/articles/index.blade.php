...
<div class="row"> 
    <div class="col-lg-2">
        <a class="btn btn-block btn-social btn-bitbucket" href="{{URL::route('articles.create')}}">
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">  
                                <li>{{ Form::open(array('route' => array('articles.destroy', $article->id), 'method' => 'delete', 'data-confirm' => 'Are you sure?')) }}
